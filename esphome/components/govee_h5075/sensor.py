...
govee_h5075_ns = cg.esphome_ns.namespace('govee_h5075')
GoveeH5075 = govee_h5075_ns.class_('GoveeH5075', esp32_ble_tracker.ESPBTDeviceListener,
                                           cg.Component)

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(GoveeH5075),
